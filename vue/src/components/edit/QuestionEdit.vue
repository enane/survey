    ...
    <div class="grid gap-3 grid-cols-12">
        <div class="mt-3 col-span-9">
            ...
            <input
                ...
                type="text" :name="'question_text_'+model.data" v-model="model.question" @change="dataChange" :id="'question_text_'+model.data">
        </div>
...
<!--    div-->
    <div v-if="shouldHaveOptions()" class="mt-2">
        <h4 class="text-sm font-semibold mb-1 flex justify-between items-center">
            Options
            <button type="button" @click="addOption()" class="text-xs py-1 px-2 rounded-sm text-white bg-gray-600 hover:bg-gray-700">
                Add Options
            </button>
        </h4>
        <div
        ...
        <div
        v-for="(option, index) in model.data.options" :key="option.uuid" class="flex items-center mb-1">
